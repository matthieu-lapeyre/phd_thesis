...
\begin{figure}[p]
\centering
    \subfloat[][Foot\_1]{\label{fig:pic_foot_1}\includegraphics[width=0.48\linewidth]{pic_foot_1.JPG}}
    \hfil
    \subfloat[][Foot\_2]{\label{fig:pic_foot_2}\includegraphics[width=0.48\linewidth]{pic_foot_2.JPG}}\\
    \subfloat[][Foot\_3]{\label{fig:pic_foot_3}\includegraphics[width=0.48\linewidth]{pic_foot_3.JPG}}
    \hfil
    \subfloat[][Foot\_4]{\label{fig:pic_foot_4}\includegraphics[width=0.48\linewidth]{pic_foot_4.JPG}}


    \subfloat[][Foot\_4]{\label{fig:pic_foot_4}\includegraphics[width=\linewidth]{foot_experience.pdf}}
