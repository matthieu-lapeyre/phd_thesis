...
Unlike virtual worlds, the real world is challenging in various ways. It is not possible to enable omniscience: we do not access the knowledge of all world states and parameters, the measures a robot can take are limited, take time and are noisy while the action taken is always different. Finally real world states are never clearly defined as precise discrete states: "the weather is never simply good or bad"~\parencite{piefer06}.
