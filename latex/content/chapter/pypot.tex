...
\begin{figure}[tb]
\centering
    \subfloat[][]{\label{fig:cpu-load}\includegraphics[width=0.5\linewidth]{cpu-load.pdf}}
    \hfil
    \subfloat[][]{\label{fig:pypy-opti}\includegraphics[width=0.5\linewidth]{pypy-opti.pdf}}
    \caption{}
    \label{fig:pypot-run}
\end{figure}
