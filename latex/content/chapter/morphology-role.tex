...
If we look closely at the morphology of the human femur, it appears that it is inclined by an angle of 6\textsuperscript{o}. This makes the feet closer to the projection of the center of gravity (CoG) (see Fig.~\ref{fig:human_thigh_experiments}) therefore it reduces the distance traveled by the CoG to move from foot to another.
...
\begin{figure}[tb]
\centering
    \subfloat[][]{\label{fig:human_thigh_experiments}\includegraphics[height=8cm]{human_thigh.jpg}}
    \hfil
