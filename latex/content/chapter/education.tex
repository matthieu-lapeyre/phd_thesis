...
\begin{formal}
    ...
    \signed{Alexander McAuley and al. The MOOC model for digital practice.~\parencite{mcauley2010mooc}}
\end{formal}
...
\begin{formal}
    ...
    \signed{Mitchel Resnick and al. Scratch: Programming for Everyone~\parencite{resnick2009scratch}}
