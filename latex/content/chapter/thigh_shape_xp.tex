...
\section{Experimental Evaluation of the Role of a Bio-inspired Thigh Shape} % (fold)
...
\subsection{Understanding the role of the thigh shape} % (fold)
...
\begin{figure}[thpb]
    \centering
    \includegraphics[width=0.9\linewidth]{dynamic_thigh_model.pdf}
