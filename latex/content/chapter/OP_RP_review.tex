...
\begin{figure}[h]
\centering
    \subfloat[][SuperDraco rocket engine has a combustion chamber 3D printed - SpaceX.]{\label{fig:superdraco}\includegraphics[height=4.5cm]{superdraco.jpg}}
    \hfil
...
\begin{figure}[h]
\centering
    \subfloat[][Creation of new open hardware project per year between 2005 and 2011.]{\label{fig:oh_project_evolution}\includegraphics[width=0.45\linewidth]{oh_project_evolution.jpg}}
    \hfil
