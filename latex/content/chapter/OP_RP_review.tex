...
\begin{figure}[h]
    \centering
        \subfloat[][SLS process]{\label{fig:SLA_process}\includegraphics[height=5cm]{SLS_technique.jpg}}
        \hfil
        \subfloat[][]{\label{fig:formlab_printer}\includegraphics[height=5cm]{SLS_part.jpg}}
        \hfil
    \caption{}
...
\begin{figure}[h]
    \centering
        \subfloat[][DMLS part]{\label{fig:SLA_process}\includegraphics[height=4.5cm]{DMLS_technique.jpg}}
        \hfil
        \subfloat[][DMLS part]{\label{fig:SLA_process}\includegraphics[height=4.5cm]{DMLS_part.jpg}}
        \hfil
    \caption{}
...
\subsection{Make possible new design} % (fold)
...
% \begin{figure}[h]
% \centering
%     \subfloat[][A conventional hinge is seen in the background and a 3D-printed metal hinge is seen in the foreground. EADS]{\label{fig:3Dprinted_part}\includegraphics[height=3.5cm]{EADS_3D_printed_hinge.jpg}}
%     \hfil
%     \subfloat[][Steel]{\label{fig:3Dprinted_steel}\includegraphics[height=3.5cm]{nice_leg_prothesis.jpg}}
%     \hfil
%     \subfloat[][Odd Guitar]{\label{fig:3Dprinted_guitar}\includegraphics[height=3.5cm]{house_printer.jpg}}
%     \caption{}
%     \label{fig:3D_printed_objects}
% \end{figure}
...
\begin{figure}[h]
\centering
    \subfloat[][SuperDraco rocket engine]{\label{fig:superdraco}\includegraphics[height=4.5cm]{superdraco.jpg}}
    \hfil
...
Lyon stimulates inventions and disseminates innovation: looms become programmable, agile order processing and production, standardization of parts, appearance countertops parts, services grow, the Lyon looms park is up to date and operational.
