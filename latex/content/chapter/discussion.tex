...
\begin{figure}[t]
\centering
    \subfloat[][Rodney Brooks and the Cog humanoid]{\includegraphics[height=5cm]{brooks_and_cog.jpg}}
    \hfil
     \subfloat[][Rodney Brooks and the Cog humanoid]{\includegraphics[height=5cm]{brooks_and_baxter.jpg}}\\
    \subfloat[][Cynthia Breazeal with Kismet]{\includegraphics[height=5cm]{breazeal_kismet.jpg}}
    \hfil
    \subfloat[][Cynthia Breazeal with Kismet]{\includegraphics[height=5cm]{breazeal_and_jibo.jpg}}
...
\section{actuation ??? faire des moteurs open source} % (fold)
