...
\begin{figure}[tb]
\centering
    \subfloat[][]{\label{fig:human_thigh_appendix}\includegraphics[height=8cm]{human_thigh.jpg}}
    \hfil
    \subfloat[][]{\label{fig:model_thigh_appendix}\includegraphics[height=8cm]{model_thigh.jpg}}
    \hfil
    \subfloat[][]{\label{fig:thigh_of_poppy_appendix}\includegraphics[height=6cm]{thigh_shape_large.jpg}}
